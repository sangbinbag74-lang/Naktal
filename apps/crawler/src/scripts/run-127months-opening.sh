#!/bin/bash
# 127월 BidOpeningDetail (OpengResult 4 op) 수집
# 사용자 명시 (2026-05-06): selPrdprcIdx ML 미적용이지만 데이터 수집은 필수
set -u
