...
(async () => {
  ...
  const r = await c.query(`SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'BidResult' ORDER BY ordinal_position`);
  console.log(`BidResult 컬럼 ${r.rowCount}개:`);
