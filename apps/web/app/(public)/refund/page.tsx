...
export const metadata: Metadata = {
  title: "환불·취소·청약철회 정책",
  description: "낙비 환불·취소·청약철회 정책. 현재 전 기능 무료 제공으로 결제 절차가 없으며, 환불 대상 거래가 발생하지 않습니다. 낙찰 수수료 0원.",
...
const SECTIONS = [
  {
    ...
    content:
      "현재 낙비는 전 기능을 무료로 제공하며 결제 절차를 운영하지 않습니다. 따라서 환불 대상이 되는 거래가 발생하지 않습니다.\n" +
      "본 정책은 장래 유료 요금제가 도입될 경우에 적용될 기준을 미리 안내하는 것이며, 유료 도입 시 시행 최소 14일 전에 공지합니다.",
  },
  {
    title: "2. 청약철회 (전액 환불)",
    content:
      "(유료 요금제 도입 시 적용) 다음의 경우 결제 금액 전액을 환불합니다.\n\n" +
      "① 결제 후 이용 기간 개시 전 — 언제든 전액 환불\n" +
      "② 이용 기간 개시 후 7일 이내로서 유료 전용 기능을 사용하지 않은 경우 — 전액 환불\n" +
      "③ 회사의 귀책 사유(시스템 오류·중복 결제 등)로 잘못 결제 처리된 경우 — 전액 환불",
  },
  {
    title: "3. 이용 중 환불 (일할 계산)",
    content:
      "(유료 요금제 도입 시 적용) 이용 기간 개시 후 중도 해지하는 경우, 다음 기준으로 환불합니다.\n\n" +
      "① 결제 금액 × (남은 일수 ÷ 결제 기간 일수) 를 환불\n" +
      "② 장기 결제에 할인이 적용된 경우, 사용한 기간을 할인 전 기준 요금으로 계산해 차감한 잔액을 환불\n" +
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F0F2F5" }}>
      ...
      <footer style={{ textAlign: "center", padding: "32px 16px", color: "#94A3B8", fontSize: 11.5, lineHeight: 1.7 }}>
        ...
        <div>대전광역시 유성구 장대로 106, 2층 제이321호 · 문의: 카카오톡 채널 낙비</div>
