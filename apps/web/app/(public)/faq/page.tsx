...
const FAQS = [
  ...
  {
    q: "요금은 어떻게 되나요?",
    a: "현재 전 기능을 무료로 개방하고 있습니다. 낙찰 수수료 0원, 구독료 0원입니다. 공고 검색·사정율 분석은 물론 정밀 투찰가 추천과 복수예가 번호 추천, 실시간 참여자 모니터, 경쟁사 분석까지 결제 없이 무제한으로 이용하실 수 있습니다. 카드 등록도 필요하지 않습니다. 유료 전환 시에는 사전에 공지드립니다.",
  },
  {
