...
export const metadata: Metadata = {
  ...
  description:
    ...
    "낙찰 수수료 0원, 무료로 시작. 5,300만 건 학습 데이터, 사정율 예측·복수예가 번호 추천·공고문 자격 자동 분석.",
  keywords: [
...
const FAQS = [
  ...
  {
    q: "요금은 어떻게 되나요?",
    a: "낙찰 수수료는 0원입니다 — 낙찰해도 떼가는 돈이 없습니다. 공고 검색·사정율 박스권은 무료이고, 정밀 투찰가·번호 추천은 무료 월 3건 후 구독으로 이용합니다. 라이트 월 9,900원(정밀 무제한), 프로 월 19,900원(AI 원본값·실시간 모니터), 비즈 49,900원·마스터 99,000원(팀·맞춤 리포트). 연간 결제 시 2개월 무료. 결제는 계좌이체(세금계산서 발행 가능)이며 자동 갱신되지 않습니다.",
  },
  {
    q: "기존 수수료 계약은 어떻게 되나요?",
    a: "2026년 7월 9일부로 낙찰 성공 수수료 제도가 폐지되었습니다. 이전에 체결된 수수료 약정도 전부 면제되어, 이후 어떠한 수수료도 청구되지 않습니다. 기존 회원에게는 프로 플랜이 무기한 무상 제공됩니다.",
  },
  {
    q: "왜 결과가 다른 분과 다른가요?",
