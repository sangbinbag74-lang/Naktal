...
export default async function ContractsPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div>
        <h2 style={{ fontSize: 22, fontWeight: 700, color: "#0F172A", margin: "0 0 4px" }}>AI 정밀 분석</h2>
        <p style={{ fontSize: 13, color: "#64748B", margin: 0 }}>
          총 {list.length}건 · 분석한 공고의 개찰 결과를 자동으로 수집해 알려드립니다
        </p>
      </div>
      ...
      {list.length === 0 ? (
        <div style={{
          ...
          <div style={{ fontSize: 15, fontWeight: 600, color: "#374151", marginBottom: 8 }}>아직 분석한 공고가 없습니다</div>
          <div style={{ fontSize: 13, color: "#9CA3AF", marginBottom: 20 }}>공고 상세에서 [AI 정밀 분석]을 누르면 추천가와 개찰 결과를 자동으로 알려드려요</div>
