...
export const metadata: Metadata = {
  ...
  description:
    ...
    "낙찰 수수료 0원 — 공고 검색·사정율 박스권 무료, 정밀 추천 월 3건 무료 후 구독(월 9,900원부터).",
  keywords: [
    // 브랜드명 변형
  ...
  openGraph: {
    ...
    description:
      ...
      "사정율 · 복수예가 번호 · 자격 · 낙찰 추적까지. 낙찰 수수료 0원, 무료로 시작.",
    url: "https://naktal.me",
    siteName: "낙비",
    locale: "ko_KR",
    type: "website",
  ...
  twitter: {
    ...
    description: "공공입찰, 데이터로 답한다. 5,300만 건 학습 AI가 0.5초 만에 사정율·복수예가·자격을 분석. 낙찰 수수료 0원, 무료로 시작.",
    images: ["/og.png"],
  },
  robots: {
    index: true,
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          ...
          "낙찰 수수료 0원 — 무료로 시작, 구독은 월 9,900원부터.",
        featureList: [
        ...
        offers: {
          ...
          highPrice: "99000",
          priceCurrency: "KRW",
          description: "무료 플랜(공고 검색·박스권·정밀 추천 월 3건)부터 라이트 9,900원 / 프로 19,900원 / 비즈 49,900원 / 마스터 99,000원(월). 낙찰 수수료 0원.",
        },
      },
      {
        "@type": "FAQPage",
        mainEntity: [
          ...
          },
          {
            "@type": "Question",
            name: "요금은 어떻게 되나요?",
            acceptedAnswer: { "@type": "Answer", text: "낙찰 수수료는 0원입니다. 공고 검색·사정율 박스권은 무료, 정밀 추천은 월 3건 무료 후 구독(라이트 월 9,900원, 프로 월 19,900원)으로 무제한 이용할 수 있습니다. 연간 결제 시 2개월 무료." },
          },
        ],
      },
    ],
