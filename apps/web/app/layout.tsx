...
export const metadata: Metadata = {
  ...
  description:
    ...
    "현재 전 기능 무료 개방 중 — 낙찰 수수료 0원, 구독료 0원. 정밀 투찰가 추천·복수예가 번호까지 무제한 무료.",
  keywords: [
    // 브랜드명 변형
    ...
    "0.5초 분석", "공고 분석 AI",
    // 가격·구독 (2026-07-09 수수료 폐지)
    "낙찰 수수료 없음", "수수료 0원", "입찰 분석 무료", "무료 입찰 분석",
    "입찰 AI 무료", "입찰 분석 전면 무료", "낙비 무료",
    // 검색 의도
  ...
  openGraph: {
    ...
    description:
      ...
      "사정율 · 복수예가 번호 · 자격 · 낙찰 추적까지. 지금 전 기능 무료 개방 중 — 구독료 0원.",
    url: "https://naktal.me",
    siteName: "낙비",
    locale: "ko_KR",
    type: "website",
  ...
  twitter: {
    ...
    description: "공공입찰, 데이터로 답한다. 5,300만 건 학습 AI가 0.5초 만에 사정율·복수예가·자격을 분석. 지금 전 기능 무료 개방 중.",
    images: ["/og.png"],
  },
  robots: {
    index: true,
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          ...
          "낙찰 수수료 0원, 구독료 0원 — 현재 전 기능을 무료로 개방하고 있습니다.",
        featureList: [
        ...
        offers: {
          ...
          highPrice: "0",
          priceCurrency: "KRW",
          description: "전 기능 무료 개방 중 — 구독료 0원, 낙찰 수수료 0원. 공고 검색·사정율 분석·정밀 투찰가 추천·복수예가 번호 추천 모두 무제한 무료.",
        },
      },
      {
        "@type": "FAQPage",
        mainEntity: [
          ...
          },
          {
            "@type": "Question",
            name: "요금은 어떻게 되나요?",
            acceptedAnswer: { "@type": "Answer", text: "현재 전 기능을 무료로 개방하고 있습니다. 낙찰 수수료 0원, 구독료 0원 — 공고 검색·사정율 분석은 물론 정밀 투찰가 추천과 복수예가 번호 추천까지 결제 없이 무제한 이용하실 수 있습니다. 카드 등록도 필요하지 않습니다." },
          },
        ],
      },
    ],
